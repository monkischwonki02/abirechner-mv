new Vue({
    ...
    methods: {
        ...
        addState(leistungskurs00){
            let stateObj = { id: "100" }; 
              
            window.history.pushState(stateObj, 
                     "leistungskurs00", "?LF11=" + leistungskurs00);
        }
    },

    computed: {
        klausurNotenRechner(){
            if (parseFloat(this.leistungskurs00.replace(",",".")) > 0 && typeof parseFloat(this.leistungskurs00) == "number"){
                this.addState(this.leistungskurs00)
        ...
        sonstNotenRechner(){
            if (parseFloat(this.leistungskurs00.replace(",",".")) > 0 && typeof parseInt(this.leistungskurs00) == "number"){
                this.addState(this.leistungskurs00)
    ...
    created(){
        ...
        if (URLSearcher.has("punkte")){
            this.leistungskurs00 = URLSearcher.get("punkte")
        } else {
            this.leistungskurs00 = ""
        }
